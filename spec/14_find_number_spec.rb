...
describe FindNumber do
  ...
  describe '#make_guess' do
    ...
    context 'when min is 5 and max is 9' do
      ...
      it 'returns 7' do
        expect(game_five.make_guess).to eq(7)
      end
    end
    ...
    context 'when min is 8 and max is 9' do
      ...
      it 'returns 8' do
        expect(game_eight.make_guess).to eq(8)
      end
    end
    ...
    context 'when min is 0 and max is 3' do
      ...
      it 'returns 1' do
        expect(game_zero.make_guess).to eq(1)
      end
    end
    ...
    context 'when min and max both equal 3' do
      ...
      it 'returns 3' do
        expect(game_three.make_guess).to eq(3)
      end
    end
  end
  ...
  describe '#game_over?' do
    context 'when guess and random_number are equal' do
      ...
      let(:random_number_equal) { double('random_number', value: 2) }
      subject(:game_equal) { described_class.new(0, 9, random_number_equal, 2) }
      ...
      it 'is game over' do
        expect(game_equal).to be_game_over
      end
    end
    ...
    context 'when guess and random_number are not equal' do
      let(:random_number_not_equal) { double('random_number', 
                                              value: 2) }
      subject(:game_not_equal) { described_class.new(0, 9,
                                                     random_number_not_equal,
                                                     3) }
      it 'is not game over' do
        expect(game_not_equal).to_not be_game_over
      end
    end
  end
  ...
  describe '#update_range' do
    ...
    context 'when the guess is 7, min=5, and max=8' do
      ...
      it 'updates min to the same value as max' do
        ...
        min = edge_case_game.min

        expect(min).to eq(edge_case_game.max)
      end

      it 'does not update max' do
        edge_case_game.update_range
        max = edge_case_game.max
